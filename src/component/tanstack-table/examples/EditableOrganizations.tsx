        ...
        return [
            ...
            columnHelper.display({
                ...
                cell: (props) => {
                    ...
                    if (table.options && table.options?.meta && table.options?.meta?.editing) {
                        editActions = (
                            <React.Fragment>
                                    ...
                                    isEditMode && (
                                        <React.Fragment>
                                            <ActionIcon color="green"
                                                        ...
                                                        title={'Save'}
                                                // type={'button'}
                                                        onClick={(e) => table.options?.meta?.editing.onSave(e)}
                                            >
                                                <IconDeviceFloppy size={theme.fontSizes.sm}/>
                                            </ActionIcon>
